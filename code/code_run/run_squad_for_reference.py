...
def main():
    ...
    ## Required parameters
    parser.add_argument("--bert_config_file", default='/home/ubuntu/PythonProj/single-BERT-backup/data/bert_config.json', type=str,
                        help="The config json file corresponding to the pre-trained BERT model. "
                             "This specifies the model architecture.")
    parser.add_argument("--vocab_file", default='/home/ubuntu/PythonProj/single-BERT-backup/data/bert-base-chinese-vocab.txt', type=str,
                        help="The vocabulary file that the BERT model was trained on.")
    parser.add_argument("--output_dir", default='output', type=str,
                        help="The output directory where the model checkpoints will be written.")
    parser.add_argument("--processed_data", default='/home/ubuntu/PythonProj/single-BERT-backup/processed_data', type=str,
                        help="The output directory where the model checkpoints will be written.")
    ...
    ## Other parameters
    parser.add_argument("--model_dir", default='/home/ubuntu/PythonProj/single-BERT-backup/model_save', type=str,
                        help="save best_model and checkpoint_model dir")
    parser.add_argument("--train_file", default='/home/ubuntu/PythonProj/single-BERT-backup/data/dxyTrain.json', type=str,
                        help="SQuAD json for training. E.g., train-v1.1.json")
    parser.add_argument("--predict_file", default='/home/ubuntu/PythonProj/single-BERT-backup/data/dxyTest.json', type=str,
                        help="SQuAD json for predictions. E.g., dev-v1.1.json or test-v1.1.json")
    parser.add_argument("--dev_file", default='/home/ubuntu/PythonProj/single-BERT-backup/data/dxyDev.json', type=str,
                        help="SQuAD json for develop. E.g., dev-v1.1.json or test-v1.1.json")
    parser.add_argument("--init_checkpoint", default='/home/ubuntu/PythonProj/single-BERT-backup/mc_base_pt.bin', type=str,
    ...
    parser.add_argument("--best_model",
                        default='/home/ubuntu/PythonProj/single-BERT-backup/model/best_model.pt', type=str,
                        help="finetuned checkpoint (usually from a pre-trained BERT model).")
    ...
    if args.do_train:
        ...
        if os.path.exists(os.path.join(args.processed_data, 'processed_train.pkl')):
            ...
            with open(args.train_file, "r") as reader:
                ...
                # input_train_data = input_train_data[:5]
    ...
    if args.do_train and args.init_checkpoint is not None:
        ...
        for key, value in state_dict.items():
            if key[0:5] == 'bert.':
                ...
                print('error')
        my_list = ["embeddings.LayerNorm.weight", "embeddings.LayerNorm.bias",
                   "encoder.layer.0.attention.output.LayerNorm.weight",
                   "encoder.layer.0.attention.output.LayerNorm.bias",
                   "encoder.layer.0.output.LayerNorm.weight", "encoder.layer.0.output.LayerNorm.bias",
                   "encoder.layer.1.attention.output.LayerNorm.weight",
                   "encoder.layer.1.attention.output.LayerNorm.bias", "encoder.layer.1.output.LayerNorm.weight",
                   "encoder.layer.1.output.LayerNorm.bias", "encoder.layer.2.attention.output.LayerNorm.weight",
                   "encoder.layer.2.attention.output.LayerNorm.bias", "encoder.layer.2.output.LayerNorm.weight",
                   "encoder.layer.2.output.LayerNorm.bias", "encoder.layer.3.attention.output.LayerNorm.weight",
                   "encoder.layer.3.attention.output.LayerNorm.bias", "encoder.layer.3.output.LayerNorm.weight",
                   "encoder.layer.3.output.LayerNorm.bias", "encoder.layer.4.attention.output.LayerNorm.weight",
                   "encoder.layer.4.attention.output.LayerNorm.bias", "encoder.layer.4.output.LayerNorm.weight",
                   "encoder.layer.4.output.LayerNorm.bias", "encoder.layer.5.attention.output.LayerNorm.weight",
                   "encoder.layer.5.attention.output.LayerNorm.bias", "encoder.layer.5.output.LayerNorm.weight",
                   "encoder.layer.5.output.LayerNorm.bias", "encoder.layer.6.attention.output.LayerNorm.weight",
                   "encoder.layer.6.attention.output.LayerNorm.bias", "encoder.layer.6.output.LayerNorm.weight",
                   "encoder.layer.6.output.LayerNorm.bias", "encoder.layer.7.attention.output.LayerNorm.weight",
                   "encoder.layer.7.attention.output.LayerNorm.bias", "encoder.layer.7.output.LayerNorm.weight",
                   "encoder.layer.7.output.LayerNorm.bias", "encoder.layer.8.attention.output.LayerNorm.weight",
                   "encoder.layer.8.attention.output.LayerNorm.bias", "encoder.layer.8.output.LayerNorm.weight",
                   "encoder.layer.8.output.LayerNorm.bias", "encoder.layer.9.attention.output.LayerNorm.weight",
                   "encoder.layer.9.attention.output.LayerNorm.bias", "encoder.layer.9.output.LayerNorm.weight",
                   "encoder.layer.9.output.LayerNorm.bias", "encoder.layer.10.attention.output.LayerNorm.weight",
                   "encoder.layer.10.attention.output.LayerNorm.bias", "encoder.layer.10.output.LayerNorm.weight",
                   "encoder.layer.10.output.LayerNorm.bias", "encoder.layer.11.attention.output.LayerNorm.weight",
                   "encoder.layer.11.attention.output.LayerNorm.bias", "encoder.layer.11.output.LayerNorm.weight",
    ...
    if args.do_train:
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                loss.backward()
                logger.info("loss value: {}".format(loss.item()))
